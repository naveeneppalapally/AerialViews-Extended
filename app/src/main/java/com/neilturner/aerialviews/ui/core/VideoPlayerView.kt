...
class VideoPlayerView
    ...
    constructor(
        ...
        fun setVideo(media: AerialMedia) {
            ...
            exoPlayer.stop()
            resizeMode = VideoPlayerHelper.getResizeMode(GeneralPrefs.videoScale)
            exoPlayer.videoScalingMode = VideoPlayerHelper.getVideoScalingMode(GeneralPrefs.videoScale)
        ...
        private fun adjustYouTubeStartForIntroSkip(
            ...
            val introSkip = Random.nextLong(YOUTUBE_INTRO_SKIP_MIN_MS, YOUTUBE_INTRO_SKIP_MAX_MS + 1)
            ...
            if (adjustedStart > startPosition) {
                Timber.i("Skipping YouTube intro segment: +${introSkip.milliseconds}")
            }
        ...
        companion object {
            ...
            const val YOUTUBE_INTRO_SKIP_MIN_MS: Long = 12_000
            const val YOUTUBE_INTRO_SKIP_MAX_MS: Long = 55_000
